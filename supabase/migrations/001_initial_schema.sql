...
-- NOTE: user_stats rows are created by app code on first login.
-- We do NOT use a trigger on auth.users because it breaks signup
-- if the migration is only partially applied.
